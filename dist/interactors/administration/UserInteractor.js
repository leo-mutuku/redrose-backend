...
let UserInteractor = class UserInteractor {
    ...
    createUser(input) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield this.repository.createUser(input);
    ...
    getUser(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield this.repository.getUser(id);
                return result;
            }
            catch (error) {
                if (error instanceof AppError_1.AppError) {
                    throw new AppError_1.AppError(`Failed to retrieve user with ID ${id}. Reason: ${error.message}`, error.statusCode || 500);
                }
    ...
    updateUser(id, input) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield this.repository.updateUser(id, input);
                return result;
            }
            catch (error) {
                throw error;
    ...
    getUsers(limit, offset) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield this.repository.getUsers(limit, offset);
                return result;
            }
            catch (error) {
                throw error;
