...
let SupplierController = class SupplierController {
    ...
    onCreateSupplier(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const body = req.body;
                const data = yield this.interactor.createSupplier(body);
    ...
    onGetSuppliers(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const offset = parseInt(req.query.offset) || 0;
                const limit = parseInt(req.query.limit) || 10;
                const data = yield this.interactor.getSuppliers(limit, offset);
    ...
    onGetSupplier(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const id = parseInt(req.params.id);
                const data = yield this.interactor.getSupplier(id);
    ...
    onUpdateSupplier(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const id = parseInt(req.params.id);
                const body = req.body;
                const data = yield this.interactor.updateSupplier(id, body);
...
exports.SupplierController = SupplierController = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(utils_1.INTERFACE_TYPE.SupplierInteractor))
], SupplierController);
