...
let UserRoleController = class UserRoleController {
    constructor(userRoleInteractor) {
        this.userRoleInteractor = userRoleInteractor;
    }
    onAssignUserRoles(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const id = parseInt(req.params.id);
                const body = req.body.roles;
                const data = yield this.userRoleInteractor.assignUserRoles(id, body);
    ...
    onUnassignUserRoles(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const id = parseInt(req.params.id);
                const body = req.body.roles;
                const data = yield this.userRoleInteractor.unassignRoles(id, body);
    ...
    onGetUserRole(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const id = parseInt(req.params.id);
                const data = yield this.userRoleInteractor.getUserRole(id);
    ...
    onUpdateUserRole(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const id = parseInt(req.params.id);
                const body = req.body;
                const data = yield this.userRoleInteractor.updateUserRole(id, body);
...
exports.UserRoleController = UserRoleController = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(utils_1.INTERFACE_TYPE.UserRoleInteractor))
], UserRoleController);
