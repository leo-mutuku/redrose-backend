...
let StoreItemController = class StoreItemController {
    ...
    onCreateStoreItem(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const body = req.body;
                const data = yield this.interactor.createStoreItem(body);
    ...
    onGetStoreItems(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const offset = parseInt(req.query.offset) || 0;
                const limit = parseInt(req.query.limit) || 10;
                const data = yield this.interactor.getStoreItems(limit, offset);
    ...
    onGetStoreItem(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const id = parseInt(req.params.id);
                const data = yield this.interactor.getStoreItem(id);
    ...
    onUpdateStoreItem(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const id = parseInt(req.params.id);
                const body = req.body;
                const data = yield this.interactor.updateStoreItem(id, body);
...
exports.StoreItemController = StoreItemController = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(utils_1.INTERFACE_TYPE.StoreItemInteractor))
], StoreItemController);
