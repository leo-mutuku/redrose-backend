...
let ItemCategoryController = class ItemCategoryController {
    ...
    onCreateItemCategory(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const body = req.body;
                const data = yield this.interactor.createItemCategory(body);
    ...
    onGetItemCategories(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const offset = parseInt(req.query.offset) || 0;
                const limit = parseInt(req.query.limit) || 10;
                const data = yield this.interactor.getItemCategories(limit, offset);
    ...
    onGetItemCategory(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const id = parseInt(req.params.id);
                const data = yield this.interactor.getItemCategory(id);
    ...
    onUpdateItemCategory(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const id = parseInt(req.params.id);
                const body = req.body;
                const data = yield this.interactor.updateItemCategory(id, body);
...
exports.ItemCategoryController = ItemCategoryController = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(utils_1.INTERFACE_TYPE.ItemCategoryInteractor))
