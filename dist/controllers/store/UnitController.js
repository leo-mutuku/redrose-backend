...
let UnitController = class UnitController {
    ...
    onCreateUnit(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const body = req.body;
                const data = yield this.interactor.createUnit(body);
    ...
    onGetUnits(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const offset = parseInt(req.query.offset) || 0;
                const limit = parseInt(req.query.limit) || 10;
                const data = yield this.interactor.getUnits(limit, offset);
    ...
    onGetUnit(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const id = parseInt(req.params.id);
                const data = yield this.interactor.getUnit(id);
    ...
    onUpdateUnit(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const id = parseInt(req.params.id);
                const body = req.body;
                const data = yield this.interactor.updateUnit(id, body);
...
exports.UnitController = UnitController = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(utils_1.INTERFACE_TYPE.UnitInteractor))
], UnitController);
