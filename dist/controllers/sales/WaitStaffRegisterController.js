...
exports.WaitStaffRegisterController = void 0;
const inversify_1 = require("inversify");
const utils_1 = require("../../utils");
let WaitStaffRegisterController = class WaitStaffRegisterController {
    constructor(interactor) {
        this.interactor = interactor;
    }
    onCreateWaitStaff(req, res, next) {
    ...
    onUpdateWaitStaff(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const id = parseInt(req.params.id);
                const body = req.body;
...
exports.WaitStaffRegisterController = WaitStaffRegisterController;
exports.WaitStaffRegisterController = WaitStaffRegisterController = __decorate([
    (0, inversify_1.injectable)(),
    __param(0, (0, inversify_1.inject)(utils_1.INTERFACE_TYPE.WaitStaffRegisterInteractor))
], WaitStaffRegisterController);
