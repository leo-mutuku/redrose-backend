...
let SalesOrderController = class SalesOrderController {
    ...
    onCreateSalesOrder(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const body = req.body;
                const data = yield this.interactor.createSalesOrder(body);
    ...
    onGetSalesOrders(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const offset = parseInt(req.query.offset) || 0;
                const limit = parseInt(req.query.limit) || 10;
                const data = yield this.interactor.getSalesOrders(limit, offset);
    ...
    onGetSalesOrder(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const id = parseInt(req.params.id);
                const data = yield this.interactor.getSalesOrder(id);
    ...
    onUpdateSalesOrder(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const id = parseInt(req.params.id);
                const body = req.body;
                const data = yield this.interactor.updateSalesOrder(id, body);
...
exports.SalesOrderController = SalesOrderController = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(utils_1.INTERFACE_TYPE.SalesOrderInteractor))
