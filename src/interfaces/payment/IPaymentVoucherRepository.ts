export interface IPaymentVoucherRepository {
     ...
     */
    createPaymentVoucher(input: any): Promise<any>;
     ...
     */
    getPaymentVoucher(id: number): Promise<any>;
     ...
     */
    updatePaymentVoucher(id: number, input: any): Promise<any>;
     ...
     */
    deletePaymentVoucher(id: number): Promise<any>;
     ...
     */
    getPaymentVouchers(limit: number, offset: number): Promise<any>;
     ...
     */
    searchPaymentVouchers(criteria: any): Promise<any>;
}
