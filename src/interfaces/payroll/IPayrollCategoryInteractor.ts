export interface IPayrollCategoryInteractor {
    /**
     ...
     */
    createPayrollCategory(input: any);
     ...
     */
    updatePayrollCategory(id: number, input: any);
     ...
     */
    getPayrollCategories(limit: number, offset: number);
}
