export interface ISalesOrderClearingRepository {
    /**
     ...
     */
    createSalesOrderClearing(input: any): Promise<any>;
     ...
     */
    //getPendingSalesOrders(limit: number, offset: number): Promise<any>;
     ...
     */
    updateSalesOrderClearing(clearingId: number, input: any): Promise<any>;
     ...
     */
    getSalesOrderClearings(limit: number, offset: number): Promise<any>;
}
