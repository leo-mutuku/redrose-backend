export interface ICancelledOrderRepository {
     ...
     */
    createCancelledOrder(input: any): Promise<any>;
     ...
     */
    getCancelledOrder(id: number): Promise<any>;
     ...
     */
    updateCancelledOrder(id: number, input: any): Promise<any>;
     ...
     */
    getCancelledOrders(limit: number, offset: number): Promise<any>;
     ...
     */
    deleteCancelledOrder(id: number): Promise<any>;
}
