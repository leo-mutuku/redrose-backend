export interface IWaitStaffRegisterInteractor {
    /**
     ...
     */
    createWaitStaffRegister(input: any);
     ...
     */
    getWaitStaffRegister(id: number);
     ...
     */
    updateWaitStaffRegister(id: number, input: any);
     ...
     */
    getWaitStaffRegisters(limit: number, offset: number);
}
